...
import Dibujo
import Interp
import qualified Basica.Test as E
import qualified Basica.Escher as ES
import qualified Basica.BasicaDoble as BD
import qualified Basica.Comun as C
...
es ancho alto = Conf {
                basic = ES.interpBas
              , fig = ES.escher 3 ES.Fish
              , width = ancho
              , height = alto
              , r = moverCentro ancho alto
}

eshd ancho alto = Conf {
                basic = ES.interpBas
              , fig = ES.escher 3 ES.FishHD
              , width = ancho
              , height = alto
              , r = moverCentro ancho alto
}
...
main = inicial $ return (es 100 100)
